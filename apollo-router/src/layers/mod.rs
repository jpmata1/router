...
pub trait ServiceBuilderExt<L>: Sized {
    ...
    /// ```
    /// uhg_custom_appollo_roouter::services::supergraph;
    /// uhg_custom_appollo_roouter::layers::ServiceBuilderExt as _;
...
///
/// ```
/// uhg_custom_appollo_roouter::layers::ServiceExt as _;
/// use tower::ServiceExt as _;
/// ```
pub trait ServiceExt<Request>: Service<Request> {
    ...
    /// # uhg_custom_appollo_roouter::services::supergraph;
    /// # uhg_custom_appollo_roouter::layers::ServiceBuilderExt;
    /// # uhg_custom_appollo_roouter::layers::ServiceExt as ApolloServiceExt;
    /// # fn test(service: supergraph::BoxService) {
